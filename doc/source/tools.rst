...
.. describe:: dms-grease input.dms output.dms [ options ]
...
plus a lipid bilayer.  If the *input.dms* is given as "-", then a pure
membrane will be built.  

The bilayer is generated by replicating a template structure, by default
an equilibrated POPC bilayer.  
