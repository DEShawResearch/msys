...
KeywordPtr keyword_segid( SystemPtr ent );
...
KeywordPtr keyword_insertion( SystemPtr ent );
KeywordPtr keyword_numbonds( SystemPtr ent );
KeywordPtr keyword_residue( SystemPtr ent );
KeywordPtr keyword_fragid( SystemPtr ent );
KeywordPtr keyword_x( SystemPtr ent, const float* pos );
KeywordPtr keyword_y( SystemPtr ent, const float* pos );
KeywordPtr keyword_z( SystemPtr ent, const float* pos );
...
KeywordPtr keyword_ctnumber( SystemPtr sys );
