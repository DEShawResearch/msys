...
static std::unordered_map<std::string,std::string> macros = {
    ...
    {"ion","resname AL BA CA Ca CAL CD CES CLA CL Cl 'Cl-' CO CS CU Cu CU1 CUA HG IN IOD K MG MN3 MO3 MO4 MO5 MO6 NA Na NAW OC7 PB POT PT RB SOD TB TL WO4 YB ZN ZN1 ZN2"},
    {"ions","ion"},
    {"sugar","resname AGLC"},
