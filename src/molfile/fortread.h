 ...
 */
static inline int fort_eat_recmark(FILE *ifp, int recmarklen) {
  int tmp;
 ...
 */
static inline int fort_get_endian_reclen(int reclen, int word0, int word1, 
...
static inline int fortread_4(void *dest, int n, int swap, FILE *fd) {
